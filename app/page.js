  ...
  return (
    <div className={`${styles.page} ${lightMode ? styles.light : ""}`}>
      ...
      <main>
        ...
        <section className={styles.socialsSection} aria-labelledby="socials-title"><div className={styles.socialsHeading}><h2 id="socials-title">Onde me encontrar</h2><p className={styles.socialsSubtitle}>Minhas redes sociais, ideias e conexões.</p></div><div className={styles.socialLinks}><a className={styles.socialLink} href="https://github.com/caua-dev-2004" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="github" /><span>GitHub</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a><a className={styles.socialLink} href="https://www.tiktok.com/@bycauazin" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="tiktok" /><span>TikTok</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a><a className={styles.socialLink} href="https://www.instagram.com/bycauazin/" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="instagram" /><span>Instagram</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a><div className={`${styles.socialLink} ${styles.disabledSocialLink}`} aria-disabled="true"><SocialIcon className={styles.socialIcon} social="linkedin" /><span>LinkedIn</span><span className={styles.socialUnavailable}>Em breve</span></div></div></section>
      ...
      <footer className={styles.footer}><span>© {new Date().getFullYear()} Cauã · bycauazin</span><div className={styles.socials} aria-label="Redes sociais"><a href="https://github.com/caua-dev-2004" target="_blank" rel="noreferrer">GitHub</a><a href="https://www.instagram.com/bycauazin/" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.tiktok.com/@bycauazin" target="_blank" rel="noreferrer">TikTok</a></div><span>feito com Next.js</span></footer>
    </div>
  );
}
