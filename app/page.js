  ...
  return (
    <div className={`${styles.page} ${lightMode ? styles.light : ""}`}>
      ...
      <main>
        ...
        <section className={styles.techSection} aria-labelledby="tech-title"><div><p className={styles.kicker} data-reveal="">Ferramentas do dia a dia</p><h2 id="tech-title" data-reveal="">O que eu uso para tirar ideias do papel.</h2></div><div className={styles.techList}>{homepageTechnologies.map((technology) => <span data-reveal="" key={technology}><TechnologyIcon className={styles.techItem} technology={technology} size="sm" showLabel /></span>)}</div></section>

        <section className={styles.servicesSection} id="servicos" aria-labelledby="services-title"><div className={styles.sectionIntro} data-reveal=""><p className={styles.kicker}>Como posso ajudar</p><h2 id="services-title">Tecnologia com contexto de negócio.</h2></div><div className={styles.serviceGrid}>{services.map((service) => <article className={styles.serviceCard} data-reveal="" key={service.number}><div className={styles.cardTop}><span>{service.number}</span><span aria-hidden="true">↗</span></div><div className={styles.serviceIcon} aria-hidden="true"><svg><use href={`/tech-icons.svg#${service.icon}`} /></svg></div><h3>{service.title}</h3><p>{service.description}</p><ul>{service.items.map((item) => <li key={item}>{item}</li>)}</ul></article>)}</div></section>

        <section className={styles.casesSection} id="projetos" aria-labelledby="cases-title"><div className={styles.sectionHeading} data-reveal=""><div><p className={styles.kicker}>Projetos</p><h2 id="cases-title">Projetos em destaque</h2><p className={styles.sectionSubtitle}>Soluções que conectam tecnologias.</p></div><p className={styles.sectionAside}>Soluções desenvolvidas com diferentes tecnologias, integrações e ferramentas.</p></div><ProjectExplorer featuredOnly showFilters={false} /><div className={styles.projectsCtaWrap} data-reveal=""><Link className={styles.buttonPrimary} href="/projetos">Acessar meus projetos <span aria-hidden="true">→</span></Link></div></section>

        <section className={styles.aboutSection} id="sobre" aria-labelledby="about-title"><div className={styles.socialPost} data-reveal=""><div className={styles.socialPostHeader}><Image className={styles.instagramLogo} src="/foto-perfil.jpg" alt="Cauã" width={20} height={20} /><strong>bycauazin</strong><span className={styles.moreIcon}>•••</span></div><div className={styles.socialMedia}><Image src="/foto-instagram.jpg" alt="Cauã criando conteúdo para redes sociais" fill sizes="(max-width: 760px) 100vw, 430px" /></div><div className={styles.socialPostFooter}><div className={styles.postActions} aria-label="Ações da publicação"><span>♡</span><span>◯</span><span>➤</span></div><span className={styles.postLabel}>vídeo curto</span></div></div><div className={styles.aboutCopy} data-reveal=""><p className={styles.kicker}>Sobre mim</p><h2 id="about-title">Um agoniado inteligente.</h2><p>Também crio conteúdo para redes sociais, compartilhando ideias, aprendizados e situações do universo da tecnologia de um jeito direto e autêntico.</p><p>Eu sou o Cauã. Gosto de entender o problema antes de escolher a ferramenta, organizar o que parece confuso e construir algo que realmente ajude no dia a dia.</p><p>Minha praia fica entre desenvolvimento, automação, dados e comunicação. O objetivo é transformar complexidade em clareza.</p></div></section>

        <section className={styles.socialsSection} aria-labelledby="socials-title"><div className={styles.socialsHeading} data-reveal=""><h2 id="socials-title">Onde me encontrar</h2><p className={styles.socialsSubtitle}>Minhas redes sociais, ideias e conexões.</p></div><div className={styles.socialLinks}><a className={styles.socialLink} data-reveal="" href="https://github.com/bycauazin" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="github" /><span>GitHub</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a><a className={styles.socialLink} data-reveal="" href="https://www.instagram.com/bycauazin/" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="instagram" /><span>Instagram</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a><a className={styles.socialLink} data-reveal="" href="https://www.linkedin.com/in/caua-santana-dev/" target="_blank" rel="noreferrer"><SocialIcon className={styles.socialIcon} social="linkedin" /><span>LinkedIn</span><span className={styles.socialArrow} aria-hidden="true">↗</span></a></div></section>

        <section className={styles.contactSection} id="contato" data-reveal="" aria-labelledby="contact-title"><p className={styles.kicker}>Tem um desafio?</p><h2 id="contact-title">Vamos transformar isso em <em>próximo passo.</em></h2><p>Me conte o que você precisa. A primeira conversa é o começo para entender e desenvolver a solução.</p><a className={styles.contactButton} href="https://wa.me/5521988120757" target="_blank" rel="noreferrer"><WhatsAppIcon size={21} /> Chamar no WhatsApp <span aria-hidden="true">↗</span></a></section>
      </main>
